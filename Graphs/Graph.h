...
class Graph {
    private:
        vector<tuple<string,string,double>> graph;
        multimap<string,pair<string,double>> maps;
        int node_count;
        multimap<string,pair<string,double>> smap;
        map<string,bool> df;
        set<tuple<double,string,string>> edge_lists;
    public:
        /**
        ...
        void simple_DFS(string a,double threshold);
